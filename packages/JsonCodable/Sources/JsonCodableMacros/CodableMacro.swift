...
extension CodableMacro {
  ...
  fileprivate static func accessModifierPrefix(from declaration: some DeclGroupSyntax) -> String {
  ...
  fileprivate static func parseProperties(
  ...
  fileprivate static func isComputedProperty(_ accessorBlock: AccessorBlockSyntax) -> Bool {
  ...
  fileprivate static func parseStringLiteral(
...
extension CodableMacro {
  fileprivate static func makeDecode(properties: [CodableProperty], access: String) -> String {
  ...
  fileprivate static func makeEncode(properties: [CodableProperty], access: String) -> String {
  ...
  fileprivate static func indent(_ text: String, by spaces: Int) -> String {
...
private enum CodingKeyDiagnostic: DiagnosticMessage {
  ...
  var message: String {
    ...
    case .multipleBindingsNotSupported:
      return
        "@JsonCodable does not support multiple bindings in one declaration; split into separate properties."
    case .stringLiteralRequired:
